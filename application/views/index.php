			...
			<div class="container">
				...
				<div class="row gy-4 align-items-center features-item">
					<div class="col-md-5 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="100">
						<img src="<?php echo base_url(); ?>assets/img/details-1.png" class="img-fluid" alt="">
					</div>
				...
				<div class="row gy-4 align-items-center features-item">
					<div class="col-md-5 order-1 order-md-2 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
						<img src="<?php echo base_url(); ?>assets/img/details-2.png" class="img-fluid" alt="">
					</div>
				...
				<div class="row gy-4 align-items-center features-item">
					<div class="col-md-5 d-flex align-items-center" data-aos="zoom-out">
						<img src="<?php echo base_url(); ?>assets/img/details-3.png" class="img-fluid" alt="">
					</div>
				...
				<div class="row gy-4 align-items-center features-item">
					<div class="col-md-5 order-1 order-md-2 d-flex align-items-center" data-aos="zoom-out">
						<img src="<?php echo base_url(); ?>assets/img/details-4.png" class="img-fluid" alt="">
					</div>
			...
			<div class="container-fluid">
				...
				<div class="row gy-4">
					...
					<div class="col-lg-5 order-1 order-lg-2">
						<img src="<?php echo base_url(); ?>assets/img/faq.jpg" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="100">
					</div>
				</div>
